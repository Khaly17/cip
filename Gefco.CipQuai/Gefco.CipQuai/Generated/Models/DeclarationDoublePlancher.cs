...
namespace Gefco.CipQuai.ApiClient.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the DeclarationDoublePlancher class.
        /// </summary>
        public DeclarationDoublePlancher()
        {
            CustomInit();
        }
        ...
        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "IsDPUsed")]
        public bool? IsDPUsed { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "MotifDps")]
        public IList<MotifDP> MotifDps { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "AutreMotifDP")]
        public string AutreMotifDP { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "NbDPCassées")]
        ...
        public virtual void Validate()
        {
            ...
            if (MotifDps != null)
            {
                foreach (var element in MotifDps)
                {
                    if (element != null)
                    {
                        element.Validate();

...
{
    public partial class DeclarationRemorque
    {
        ...
        /// </return>
        public async Task<HttpOperationResponse<PictureServiceResult>> UploadPictureSPWithHttpMessagesAsync(string appVersion, string id, int pictureType, string declarationId, string fileName, Stream file, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (appVersion == null)
            {
            ...
            if (_shouldTrace)
            {
                ...
                ServiceClientTracing.Enter(_invocationId, this, "UploadPictureSP", tracingParameters);
            }
            // Construct URL
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<HttpOperationResponse<PictureServiceResult>> UploadPicSPWithHttpMessagesAsync(string appVersion, string id, int pictureType, string declarationId, string fileName, string fileContent, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (appVersion == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "appVersion");
            ...
            if (_shouldTrace)
            {
                ...
                tracingParameters.Add("cancellationToken", cancellationToken);
                ServiceClientTracing.Enter(_invocationId, this, "UploadPicSP", tracingParameters);
            }
            // Construct URL
            var _baseUrl = Client.BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl
                                                     + (_baseUrl.EndsWith("/")
                                                            ? ""
                                                            : "/")), "UploadPicSP").ToString();
            // Create HTTP transport objects
            var _httpRequest = new HttpRequestMessage();
            HttpResponseMessage _httpResponse = null;
            _httpRequest.Method = new HttpMethod("POST");
            _httpRequest.RequestUri = new System.Uri(_url);
            //_httpRequest.Content = new FormUrlEncodedContent(new[] {new KeyValuePair<string, string>("fileContent", fileContent)});
            // Set Headers

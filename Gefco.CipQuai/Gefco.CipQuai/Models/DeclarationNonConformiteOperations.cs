...
{
    public partial class DeclarationNonConformiteOperations
    {
        ...
        /// </return>
        public async Task<HttpOperationResponse<PictureServiceResult>> UploadPictureNCWithHttpMessagesAsync(string appVersion, string id, int pictureType, string declarationId, string fileName, Stream file, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (appVersion == null)
            {
            ...
            if (_shouldTrace)
            {
                ...
                ServiceClientTracing.Enter(_invocationId, this, "UploadPictureNC", tracingParameters);
            }
            // Construct URL
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<HttpOperationResponse<PictureServiceResult>> UploadPicNCWithHttpMessagesAsync(string appVersion, string id, int pictureType, string declarationId, string fileName, string fileContent, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (appVersion == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "appVersion");
            ...
            if (_shouldTrace)
            {
                ...
                tracingParameters.Add("cancellationToken", cancellationToken);
                ServiceClientTracing.Enter(_invocationId, this, "UploadPicNC", tracingParameters);
            }
            // Construct URL
            var _baseUrl = Client.BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl

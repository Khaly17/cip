...
namespace Gefco.CipQuai.ControleReceptionPage
{
    ...
    public partial class TakePicturesPage
    {
        ...
        public TakePicturesPage(CRViewModel CRViewModel)
        {
            ViewModel = CRViewModel;
            NavigationPage.SetHasNavigationBar(this, false);
            InitializeComponent();
            BindingContext = new TakePicturesPageViewmodel(CRViewModel);
        }
    ...
    public class TakePicturesPageViewmodel : ViewModelBaseExt
    {
        ...
        public TakePicturesPageViewmodel(CRViewModel CRViewModel)
        {
            ViewModel = CRViewModel;

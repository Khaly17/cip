...
{
    public partial class DPUsedSummaryPage
    {
        public DPViewModel ViewModel { get; }

        public DPUsedSummaryPage(DPViewModel dpViewModel)
        {
            ViewModel = dpViewModel;
            InitializeComponent();
            BindingContext = new DPUsedSummaryPageViewModel(dpViewModel);
        }
        ...
        private void SuspendDeclaration(object sender, EventArgs e)
        {
            ...
            ViewModel.SuspendDeclaration(FlowState.DPUsedSummary);
            GoHome();
        }
        ...
        {
            CancelBottomMenu(null, null);
            ViewModel.StopAndFreeDeclaration(FlowState.DPUsedSummary);
            GoHome();
        }
    ...
    public class DPUsedSummaryPageViewModel : ViewModelBaseExt
    {
        public DPViewModel ViewModel { get; }

        public DPUsedSummaryPageViewModel()
        {
            
        }
        public DPUsedSummaryPageViewModel(DPViewModel dpViewModel)
        {
            ViewModel = dpViewModel;
        ...
        {
            IsLoading = true;
            await ViewModel.EndDeclarationAsync(true);

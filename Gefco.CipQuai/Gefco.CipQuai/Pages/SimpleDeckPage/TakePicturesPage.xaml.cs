...
namespace Gefco.CipQuai.SimpleDeckPage
{
    ...
    public partial class TakePicturesPage
    {
        ...
        public TakePicturesPage(SPViewModel SPViewModel)
        {
            ViewModel = SPViewModel;
            NavigationPage.SetHasNavigationBar(this, false);
            InitializeComponent();
            BindingContext = new TakePicturesPageViewmodel(SPViewModel);
        }
    ...
    public class TakePicturesPageViewmodel : ViewModelBaseExt
    {
        ...
        public TakePicturesPageViewmodel(SPViewModel SPViewModel)
        {
            ViewModel = SPViewModel;

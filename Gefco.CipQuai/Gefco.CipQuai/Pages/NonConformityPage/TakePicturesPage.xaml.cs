...
namespace Gefco.CipQuai.NonConformityPage
{
    ...
    public partial class TakePicturesPage
    {
        ...
        public TakePicturesPage(NCViewModel ncViewModel)
        {
            ViewModel = ncViewModel;
            NavigationPage.SetHasNavigationBar(this, false);
            InitializeComponent();
            BindingContext = new TakePicturesPageViewmodel(ncViewModel);
        }
    ...
    public class TakePicturesPageViewmodel : ViewModelBaseExt
    {
        ...
        public TakePicturesPageViewmodel(NCViewModel ncViewModel)
        {
            ViewModel = ncViewModel;

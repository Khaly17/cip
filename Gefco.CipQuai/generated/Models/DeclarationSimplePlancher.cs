...
{
    /// <summary> The DeclarationSimplePlancher. </summary>
    public partial class DeclarationSimplePlancher
    {
        /// <summary> Initializes a new instance of DeclarationSimplePlancher. </summary>
        /// <param name="id"></param>
        /// <param name="creationDate"></param>
        /// <exception cref="ArgumentNullException"> <paramref name="id"/> is null. </exception>
        public DeclarationSimplePlancher(string id, DateTimeOffset creationDate)
        {
            if (id == null)
            {

...
{
    public class DetailCRViewModel
    {
        public DetailCRViewModel(DeclarationControleReception declaration, List<TempPicture> tempPictures)
        {
            CompletionDate = declaration.CreationDate;
            Origine = declaration.CreatedBy.FirstName + " " + declaration.CreatedBy.LastName;
            Agence = declaration.Agence.Name;

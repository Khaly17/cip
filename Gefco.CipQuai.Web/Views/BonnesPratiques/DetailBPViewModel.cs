...
{
    public class DetailBPViewModel
    {
        public DetailBPViewModel(DeclarationBonnePratique declaration, List<TempPicture> tempPictures)
        {
            CompletionDate = declaration.CreationDate.ToLocalTime();
            Origine = declaration.CreatedBy.FirstName + " " + declaration.CreatedBy.LastName;
            Destination = declaration.AutreAgentConcerné;
